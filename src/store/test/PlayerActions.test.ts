...
describe('TournamentActions.ts exported functions', () => {
  ...
  test('Update player with leading and trailing spaces', () => {
    const playerNameWithSpaces = ' The Power  '
    const playerName = 'The Power'
    newTournament()
    updatePlayer(0, playerNameWithSpaces)
  ...
  test('Update player with to many characters', () => {
    const longPlayerName = '01234567890123456789012345678901abc'
    const expectedPlayerName = '01234567890123456789012345678901'
    newTournament()
    updatePlayer(0, longPlayerName)
  ...
  test('Update player with to many characters and leading and trailing spaces', () => {
    const longPlayerName = '  01234567890123456789012345678901abc  '
    const expectedPlayerName = '01234567890123456789012345678901'
    newTournament()
    updatePlayer(0, longPlayerName)
  ...
  test('Update player with only spaces', () => {
    const playerNameWithSpaces = '   '
    const playerName = ''
    newTournament()
    updatePlayer(0, playerNameWithSpaces)
